      ...
      <div className="max-w-[1080px] mx-auto px-6 md:px-12 lg:px-24">
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-10">
          {PRODUCTS.map((product) => (
            ...
            >
              <div
                className={`aspect-[4/5] w-full rounded-[var(--radius-md)] bg-gradient-to-b ${product.gradient} flex items-center justify-center transition-all duration-500 group-hover:brightness-110`}
              >
                <div className="text-center">
        ...
        <div className="mt-12 text-center">
          <a
            href="/shop"
            className="inline-flex text-sm tracking-[0.05em] text-[var(--color-text-muted)] hover:text-[var(--color-accent)] transition-colors duration-500"
          >
            观览全部 &rarr;
          </a>
        </div>
